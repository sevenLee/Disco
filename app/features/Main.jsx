                            ...
                            <Col xs={24} sm={24} lg={10} key="main">
                                <div className="p-lg">
                                    ...
                                    <div>
                                        ...
                                        <a className="btn btn-block btn-info btn-lg" href="https://api.instagram.com/oauth/authorize/?client_id=9f7d8bdab0194595821d743a508b1239&redirect_uri=http://localhost:3000/&response_type=token&scope=public_content+follower_list+likes">IG 2 Login</a>
